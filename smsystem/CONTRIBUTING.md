# Contributing to app-admin

We would love for you to contribute to app-admin and help make it ever better together! :rocket:
...
Help us keep app-admin open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `app-admin`.
...
* If you have a question about using app-admin, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `app-admin:master`.
...
we use the git commit messages to **generate the app-admin change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/app-admin
[stackoverflow]: https://stackoverflow.com/questions/tagged/app-admin
[issues]: https://github.com/akveo/app-admin/issues
[new_issue]: https://github.com/akveo/app-admin/issues/new
[pulls]: https://github.com/akveo/app-admin/pulls
