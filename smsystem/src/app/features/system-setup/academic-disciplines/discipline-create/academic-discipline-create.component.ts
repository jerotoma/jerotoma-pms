...
@Component({
  ...
  templateUrl: 'academic-discipline-create.component.html',
  styleUrls: ['academic-discipline-create.component.scss'],
})
export class AcademicDisciplineCreateComponent implements OnInit {
  @Input() title: string;
  ...
  constructor(
    ...
    protected ref: NbDialogRef<AcademicDisciplineCreateComponent>) {}
