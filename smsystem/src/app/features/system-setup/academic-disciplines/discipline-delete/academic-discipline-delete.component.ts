...
@Component({
  ...
  templateUrl: 'academic-discipline-delete.component.html',
  styleUrls: ['academic-discipline-delete.component.scss'],
})
export class AcademicDisciplineDeleteComponent implements OnInit {
  positionId: string = '0';
  title: string = '';
  action: string = '';
  name: string = '';
  ...
  constructor(
    ...
    protected ref: NbDialogRef<AcademicDisciplineDeleteComponent>) {}
  ngOnInit() {
