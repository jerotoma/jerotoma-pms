...
@Component
public class CustomAccessDiniedException extends AccessDeniedHandlerImpl {
	
	protected static final Log logger = LogFactory.getLog(CustomAccessDiniedException.class);
